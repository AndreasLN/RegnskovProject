...
public class LEDView : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        Rect currentViewSize = new Rect(0, 0, Screen.width-20, Screen.height - 60);
        Rect fullViewSize = new Rect(0, 0, Screen.width, Screen.height);
        ...
        currentViewSize.x = (float)Screen.width * .5f - currentViewSize.width * .5f;
